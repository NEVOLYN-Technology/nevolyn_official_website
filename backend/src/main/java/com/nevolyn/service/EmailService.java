...
/**
 * Non-blocking asynchronous email delivery service for the NEVOLYN Technology platform.
 *
...
public class EmailService {
     ...
     */
    @Value("${app.email.from:info@nevolyn.com}")
    private String fromEmail;

    /** Destination for step-2 admin dossiers. */
    @Value("${app.email.admin:admin@nevolyn.com}")
    ...
    /** Friendly From display name, e.g. {@code NEVOLYN Technology <noreply@…>}. */
    @Value("${app.email.sender-name:NEVOLYN Technology}")
    ...
    public void sendSenderVerificationEmail(String recipientEmail, String name, String trackingId, String type) {
        ...
        String subjectPrefix = "application".equalsIgnoreCase(type) ? "Application Received"
                : "Inquiry Received";
        String subject = subjectPrefix + " [" + trackingId + "] - NEVOLYN Technology";
     ...
     * {@code https://nevolyn.com} — and verification links follow
