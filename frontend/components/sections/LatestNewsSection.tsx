                    ...
                    >
                      ...
                      <div className="relative w-full h-full p-6 sm:p-7 rounded-[26px] bg-slate-950/95 dark:bg-[#070f1e]/95 backdrop-blur-2xl flex flex-col justify-between overflow-hidden">
                        ...
                        <div>
                          ...
                          <h4 className="text-xl sm:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-slate-200 group-hover:from-orange-400 group-hover:to-amber-300 transition-all duration-300 tracking-tight leading-snug mb-3 drop-shadow-sm">
                            {item.title}
                          </h4>
          ...
          <div className="space-y-4">
            {sortedNews.map((item, idx) => (
              <motion.div
                ...
                className="p-[1.5px] rounded-2xl bg-gradient-to-r from-slate-800/80 via-slate-700/50 to-slate-800/80 hover:from-orange-500/60 hover:via-amber-500/40 hover:to-orange-500/30 hover:shadow-[0_10px_30px_rgba(249,115,22,0.18)] transition-all duration-500 group cursor-pointer"
              >
                <div className="p-5 sm:p-6 rounded-[14px] bg-slate-950/90 dark:bg-[#070e1a]/95 backdrop-blur-xl relative overflow-hidden flex flex-col justify-between">
                  {/* Left Accent Beam */}
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-slate-800 group-hover:bg-gradient-to-b group-hover:from-orange-500 group-hover:via-amber-400 group-hover:to-orange-500 group-hover:shadow-[0_0_10px_rgba(249,115,22,0.5)] transition-all duration-300" />
                  ...
                  <div className="mb-2 pl-2">
                    ...
                    <div className="flex items-center justify-between gap-2 mb-3">
                      ...
                      <Badge tone="info" className="shrink-0 bg-slate-900 text-orange-400 border border-orange-500/20 group-hover:border-orange-500/40">
                        {item.category}
                      </Badge>
                    </div>

                    {/* Title */}
                    <h4 className="text-base sm:text-lg font-bold text-white group-hover:text-orange-400 transition-colors leading-snug mb-2">
                      {item.title}
                    </h4>

                    {/* Preview Description */}
                    <p className="text-slate-200 text-xs sm:text-sm font-medium leading-relaxed mb-2">
                      {item.description}
                    </p>
