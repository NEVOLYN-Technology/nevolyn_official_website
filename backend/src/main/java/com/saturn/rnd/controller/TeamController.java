 ...
 *
 * <p><strong>Endpoint:</strong> {@code GET /api/v1/team/members}</p>
 * <p><strong>Access Control:</strong> Public</p>
 *
 * <h2>Usage Scenarios</h2>
 * <ul>
 *   <li>Allows frontend to fetch active staff dynamically from database.</li>
 *   <li>Supports optional query filtering by department (e.g. {@code ?department=Industrial%20AI}).</li>
 * </ul>
 *
...
public class TeamController {
     ...
     * @return {@link ResponseEntity} containing standardized {@link ApiResponse} wrapping list of {@link TeamMemberDto}
     */
    @GetMapping
