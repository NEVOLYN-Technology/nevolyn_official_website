 ...
 *
 * <p><strong>Endpoint:</strong> {@code POST /api/v1/contact}</p>
 * <p><strong>Payload Type:</strong> {@code application/json}</p>
 * <p><strong>Access Control:</strong> Public</p>
 *
 * <h2>Processing Workflow</h2>
 * <ol>
 *   <li>Intercepts JSON payload from frontend contact form ({@code ContactSection.tsx}).</li>
 *   <li>Enforces Bean Validation constraints ({@code @Valid}) via Spring Validation.</li>
 *   <li>Delegates entity persistence and unique ID generation to {@link ContactService}.</li>
 *   <li>Wraps result in a standardized {@link ApiResponse} JSON envelope returning HTTP 201 (Created).</li>
 * </ol>
 *
...
public class ContactController {
     ...
     *
     * @param request Validated JSON body containing name, email, subject, and message
     * @return {@link ResponseEntity} containing standardized {@link ApiResponse} envelope with generated inquiry ID
     */
    @PostMapping
